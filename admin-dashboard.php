...
// Вземи имейла на логнатия потребител от сесията
...
$motivation_index = date('z') % count($motivations);
$motivation_message = $motivations[$motivation_index];
?>
<!DOCTYPE html>
<html
  lang="en"
                      ...
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">
                            Здравей, <?php echo htmlspecialchars($first_name . ' ' . $last_name); ?>! 🎉
                          </h5>
                          ...
                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">Започни работа</a>
                        </div>
                      </div>
